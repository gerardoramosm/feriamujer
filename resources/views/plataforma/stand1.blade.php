    ...
    <div class="iframe-container">
        ...
        @php 
            $coords=array(
                ...
                500=>array(908,216,119,66,500,199,371,116,126,133,188,266,847,348,162,71,1009,348,71,71,934,116,54,54,934,173,54,54,722,323,103,66),
        ...
        <a href="#" data-toggle="modal" data-target="#nosotros" >
            ...
            @if(file_exists(dirname(base_path()).'/fvirtual/public/img/stand_images/'.$st->id_user.'_'.$sel.'_1.jpg'))
                <image x="{{$coords[$st->tipo][0]}}" y="{{$coords[$st->tipo][1]}}" width="{{$coords[$st->tipo][2]}}" height="{{$coords[$st->tipo][3]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user}}_{{$sel}}_1.jpg?{{date('Y-m-d H:i:s')}}"></image>
            @else
        ...
        <a href="#" data-toggle="modal" data-target="#productos" >
            ...
            @if(file_exists(dirname(base_path()).'/fvirtual/public/img/stand_images/'.$st->id_user.'_'.$sel.'_2.jpg'))
                <image x="{{$coords[$st->tipo][4]}}" y="{{$coords[$st->tipo][5]}}" width="{{$coords[$st->tipo][6]}}" height="{{$coords[$st->tipo][7]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user}}_{{$sel}}_2.jpg?{{date('Y-m-d H:i:s')}}"></image>
            @else
        ...
        <a href="#" data-toggle="modal" data-target="#contactos" >
            @if(file_exists(dirname(base_path()).'/fvirtual/public/img/stand_images/'.$st->id_user.'_'.$sel.'_1.jpg'))
                <image x="{{$coords[$st->tipo][0]}}" y="{{$coords[$st->tipo][1]}}" width="{{$coords[$st->tipo][2]}}" height="{{$coords[$st->tipo][3]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user.'_'.$sel}}_1.jpg?{{date('Y-m-d H')}}"></image>
            @else
                <image x="{{$coords[$st->tipo][0]}}" y="{{$coords[$st->tipo][1]}}" width="{{$coords[$st->tipo][2]}}" height="{{$coords[$st->tipo][3]}}" xlink:href="https://reactivaproductiva.feicobol.com/img/modif_stands/contactos.jpg"></image>
            @endif
        </a>
        <a href="{{asset('img/modif_stands/SOALPROpanetones.pdf')}}">
            @if(file_exists(dirname(base_path()).'/fvirtual/public/img/stand_images/'.$st->id_user.'_'.$sel.'_2.jpg'))
                <image x="{{$coords[$st->tipo][4]}}" y="{{$coords[$st->tipo][5]}}" width="{{$coords[$st->tipo][6]}}" height="{{$coords[$st->tipo][7]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user.'_'.$sel}}_2.jpg?{{date('Y-m-d H')}}"></image>
            @else
                <image x="{{$coords[$st->tipo][4]}}" y="{{$coords[$st->tipo][5]}}" width="{{$coords[$st->tipo][6]}}" height="{{$coords[$st->tipo][7]}}" xlink:href="https://reactivaproductiva.feicobol.com/img/modif_stands/productos.jpg"></image>
            @endif
        </a>
        @endif
        @if(file_exists(dirname(base_path()).'/fvirtual/public/img/stand_images/'.$st->id_user.'_'.$sel.'_3.jpg'))
            @if($st->logo=="12615_86")
            <a href="http://soalpro.com/quienes_somos.html" target="_blank">
                <image x="{{$coords[$st->tipo][8]}}" y="{{$coords[$st->tipo][9]}}" width="{{$coords[$st->tipo][10]}}" height="{{$coords[$st->tipo][11]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user}}_{{$sel}}_3.jpg?{{date('Y-m-d H:i:s')}}"></image>
            </a>
            @else
                <image x="{{$coords[$st->tipo][8]}}" y="{{$coords[$st->tipo][9]}}" width="{{$coords[$st->tipo][10]}}" height="{{$coords[$st->tipo][11]}}" xlink:href="https://virtual.feicobol.com.bo/img/stand_images/{{$st->id_user}}_{{$sel}}_3.jpg?{{date('Y-m-d H:i:s')}}"></image>
            @endif
        ...
        @endif
        @if(file_exists(dirname(base_path()).'/expositores/public/images/logos/'.$st->id_user.'_'.$sel.'.jpg'))
            <image x="{{$coords[$st->tipo][12]}}" y="{{$coords[$st->tipo][13]}}" width="{{$coords[$st->tipo][14]+$coords[$st->tipo][18]}}" height="{{$coords[$st->tipo][15]}}" xlink:href="https://expositores.feicobol.com.bo/images/logos/{{$st->id_user}}_{{$sel}}.jpg?{{date('Y-m-d H:i:s')}}"></image>
        @else
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <img src="https://expositores.feicobol.com.bo/images/logos/{{$st->id_user}}_{{$sel}}.jpg?{{date('Y-m-d H:i:s')}}" width="100%"><br>
                    <div class="row">
                @if($st->fb!='')
                ...
                @endif
                @if($st->wpp!='')
                    <a href="https://wa.me/591{{$st->wpp}}?text=Quiero%20mas%20informacion" style="padding:10px;font-size:20px" target="_blank" class="fa fa-whatsapp"></a><!--{{$st->wpp}}<br>-->
                @endif
                ...
                @if($st->telefono_responsable!='')
                    @handheld
                    <a href="tel:{{$st->telefono_contacto}}" style="padding:10px;font-size:20px" target="_blank" class="fa fa-phone"></a><!--{{$st->telefono_contacto}}-->
                    @elsehandheld
                    ...
                    {{$st->telefono_contacto}}</span>
                    @endhandheld
                @endif
                </div></div>
                @endif
                <div class="col-9">
                    <h4 style="display: contents">{{$st->nombre}}</h4><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card">
                    ...
                    <a class="btn btn-success" href="https://wa.me/591{{$st->wpp}}?text=Quiero%20adquirir%20{{rawurlencode($p->nombre)}}">Clic aquí para comprar</a>
                    @if($p->envasado!="0")
...
@mobile
<div class="container">
    <h1 style="text-align: center;">{{$st->nombre_empresa }}</h1>
    ...
    <div class="col-md-12">
    <h4 style="display: contents">{{$st->nombre_empresa }}</h4><br>
    {{$st->descripcion}}
    <div class="row">
        @if($st->video!='')
...
<div class="row">
    @foreach($ejecutivos as $ej)
    <div class="col-md-3">
        @if(file_exists(dirname(base_path()).'/reactiva/public/img/ejecutivos/'.$ej->id_ejecutivo.'.jpg'))
        <img src="{{asset('img/ejecutivos/'.$ej->id_ejecutivo.'.jpg')}}" style="width: 100%">
        @else
        <img src="{{asset('img/contact.png')}}" style="width: 100%">
        @endif
        <h4 style="text-align: center">{{$ej->nombre}}</h4>
        <span>{!!$ej->cargo!!}</span>
        <a href="@if($ej->modo_contacto==1) @if(is_numeric($ej->link)) https://wa.me/591{{$ej->link}}?text=Quiero%20mas%20informacion @else @if(strpos($ej->link, 'https') !== false) {{$ej->link}} @else https://{{$ej->link}} @endif @endif  @else https://{{$ej->link}} @endif" target="_blank" class="btn btn-primary">Conversemos!</a>
    </div>
    @endforeach
</div>
@endif
